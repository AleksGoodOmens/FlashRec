  ...
  var e = {
      ...
      408: (e, t, s) => {
        ...
        e.exports = function (e, t, s) {
          var i,
            ...
            L = n(t, E),
            A = function (e) {
              return i && p(i, "normal", e), new g(!0, e);
            },
            I = function (e) {
              return C
      ...
      2140: (e, t, s) => {
        ...
        e.exports = function (e, t) {
          ...
          if ("string" === t && r((s = e.toString)) && !o((i = n(s, e))))
            return i;
          if (r((s = e.valueOf)) && !o((i = n(s, e)))) return i;
          if ("string" !== t && r((s = e.toString)) && !o((i = n(s, e))))
            return i;
      ...
      7593: (e, t, s) => {
        ...
        e.exports = function (e, t) {
          ...
          if (i) {
            if (
              (void 0 === t && (t = "default"), (s = n(i, e, t)), !r(s) || o(s))
            )
              return s;
      ...
      7327: (e, t, s) => {
        ...
        var i = s(2109),
          n = s(2092).filter;
        i(
          { target: "Array", proto: !0, forced: !s(1194)("filter") },
          {
            filter: function (e) {
          ...
          var t = "undefined" != typeof window,
            ...
            oe = function (e, t, s) {
              !(function (e) {
                ...
                re(e, t, s),
                (function (e) {
                  F(e) || (e[p] = { backgroundImage: e.style.backgroundImage });
                })(e),
                (function (e, t, s) {
                  var i = S(e, t.data_bg),
    ...
    (() => {
            ...
            for (let t = 0, n = s.length; t < n; t += 1) {
              ...
              void 0 !== r &&
                ...
                ($(e[n]) && $(i[n])
                  ...
                  : !$(e[n]) && $(i[n])
                  ? ((e[n] = {}),
                    i[n].__swiper__ ? (e[n] = i[n]) : D(e[n], i[n]))
                  : (e[n] = i[n]));
            }
          }
        }
      ...
      const K = {
        loopCreate: function () {
          ...
          for (let e = 0; e < a.length; e += 1)
            n.append(k(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
          for (let e = o.length - 1; e >= 0; e -= 1)
            n.prepend(k(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
        },
        loopFix: function () {
          const e = this;
      ...
      const oe = {
          attachEvents: function () {
            ...
            (e.onTouchStart = Z.bind(e)),
              ...
              i.touch &&
                !ie &&
                (t.addEventListener("touchstart", ne), (ie = !0)),
              re(e, "on");
          },
      ...
      function ve(e) {
        ...
        function d() {
          ...
          if (
            ("fraction" === s.type &&
              (r.find(me(s.currentClass)).text(s.formatFractionCurrent(d + 1)),
              r.find(me(s.totalClass)).text(s.formatFractionTotal(u))),
            "progressbar" === s.type)
          ) {
            let e;
        ...
        function l() {
          ...
          if (
            ...
            e.children(`.${s.slideVisibleClass}`).each((e) => {
              a(r ? k(e).attr("data-swiper-slide-index") : k(e).index());
            });
      ...
      window.addEventListener("load", function (e) {
        Se(),
          document.querySelector(
            ".body-main-slider, .body-cv-slider, .body-skills-slider"
          ) &&
            new ge(".body-main-slider, .body-cv-slider, .body-skills-slider", {
              modules: [ve, xe, ye, be],
              effect: "fade",
          ...
          document.querySelector(".gallery-slider") &&
            new ge(".gallery-slider", {
              ...
              loop: !0,
              preloadImages: !0,
              lazy: { loadPrevNextAmount: 6, loadPrevNext: !0 },
              freeMode: { enabled: !0 },
              on: {},
            }),
          document.querySelector(".awards-slider") &&
            new ge(".awards-slider", {
              modules: [be, ye],
          ...
          document.querySelector(".work-slider") &&
            new ge(".work-slider", {
              ...
              loop: !0,
              preloadImages: !0,
              lazy: { loadPrevNextAmount: 2, loadPrevNext: !0 },
              freeMode: { enabled: !0 },
              on: {},
            });
      });
      ...
      var $e,
        ...
        De = function (e, t) {
          (this.inlineSize = e), (this.blockSize = t), ze(this);
        },
        Be = (function () {
          function e(e, t, s, i) {
            return (
        ...
        Fe = /auto|scroll/,
        He = /^tb|vertical/,
        Ve = /msie|trident/i.test(We.navigator && We.navigator.userAgent),
        qe = function (e) {
        ...
        Ue = function (e, t) {
          if ((void 0 === t && (t = !1), Ge.has(e) && !t)) return Ge.get(e);
          if (je(e)) return Ge.set(e, Ye), Ye;
          var s = getComputedStyle(e),
            i = Ne(e) && e.ownerSVGElement && e.getBBox(),
            n = !Ve && "border-box" === s.boxSizing,
            r = He.test(s.writingMode || ""),
            o = !i && Fe.test(s.overflowY || ""),
            a = !i && Fe.test(s.overflowX || ""),
            l = i ? 0 : qe(s.paddingTop),
            c = i ? 0 : qe(s.paddingRight),
            d = i ? 0 : qe(s.paddingBottom),
            u = i ? 0 : qe(s.paddingLeft),
            h = i ? 0 : qe(s.borderTopWidth),
            p = i ? 0 : qe(s.borderRightWidth),
            f = i ? 0 : qe(s.borderBottomWidth),
            g = u + c,
            m = l + d,
            v = (i ? 0 : qe(s.borderLeftWidth)) + p,
            y = h + f,
            b = a ? e.offsetHeight - y - e.clientHeight : 0,
            w = o ? e.offsetWidth - v - e.clientWidth : 0,
            x = n ? g + v : 0,
            S = n ? m + y : 0,
            E = i ? i.width : qe(s.width) - x - w,
            C = i ? i.height : qe(s.height) - S - b,
            T = E + g + w + v,
            O = C + m + b + y,
            L = ze({
              devicePixelContentBoxSize: Xe(
        ...
        Ze = function (e) {
          ...
          (this.target = e),
            ...
            (this.borderBoxSize = ze([t.borderBoxSize])),
            (this.contentBoxSize = ze([t.contentBoxSize])),
            (this.devicePixelContentBoxSize = ze([
      ...
      Te() &&
        window.addEventListener("resize", function () {
          xt !== window.devicePixelRatio &&
            ((xt = window.devicePixelRatio), (wt = null));
        });
      var Et = (function () {
        function e(t, s) {
          var i = this;
          (this.onScroll = function () {
            ...
            e.instances.has(this.el) ||
              ...
              (e.getRtlHelpers = _e()(e.getRtlHelpers)),
              this.init());
        }
      ...
      var Xt = (function () {
        ...
        return (
          ...
          (e.prototype.find = function (e) {
            return Yt(this._getSelector(e, this.selector));
          }),
          ...
          (e.prototype.eq = function (e) {
            return Yt(this.selector[e]);
          }),
          (e.prototype.parent = function () {
            return Yt(this.selector.parentElement);
          }),
      ...
      var Zt = function (e, t, s, i) {
          void 0 === s && (s = 0);
          var n = Yt(e).attr("data-lg-size") || i;
          if (n) {
            var r = n.split(",");
            if (r[1])
          ...
          return (
            ...
            (e.prototype.init = function () {
              ...
              this.addSlideVideoInfo(this.galleryItems),
                this.buildStructure(),
                this.LGel.trigger(At, { instance: this }),
            ...
            (e.prototype.getSlideItem = function (e) {
              return Yt(this.getSlideItemId(e));
            }),
                ...
                var n = this.settings.ariaLabelledby
                  ...
                  c =
                    ...
                    (".lg-sub-html" === this.settings.appendSubHtmlTo
                      ...
                      : "") +
                    "\n                </div>\n            </div>\n        </div>\n        ";
                Yt(this.settings.container).append(c),
                  document.body !== this.settings.container &&
                    Yt(this.settings.container).css("position", "relative"),
              ...
              if ("this" === this.settings.selector) this.items.push(this.el);
                ...
                if ("string" == typeof this.settings.selector)
                  if (this.settings.selectWithin) {
                    var e = Yt(this.settings.selectWithin);
            ...
            (e.prototype.openGallery = function (e, t) {
              ...
              if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
                ...
                setTimeout(function () {
                  ...
                  (this.lGalleryOn = !1),
                  (this.prevScrollTop = Yt(window).scrollTop()),
                  setTimeout(function () {
            ...
            (e.prototype.addHtml = function (e) {
                ...
                if (t) {
                  ...
                  ("." !== i && "#" !== i) ||
                    (t =
                      ...
                      !this.settings.dynamic
                        ? Yt(this.items).eq(e).find(t).first().html()
                        : Yt(t).first().html());
                } else t = "";
              if (".lg-item" !== this.settings.appendSubHtmlTo)
                ...
                var n = Yt(this.getSlideItemId(e));
                s
                  ? n.load(s)
            ...
            (e.prototype.getDummyImageContent = function (e, t, s) {
              var i;
              if ((this.settings.dynamic || (i = Yt(this.items).eq(t)), i)) {
                var n = void 0;
                if (
            ...
            (e.prototype.addSlideVideoInfo = function (e) {
              ...
              e.forEach(function (e, s) {
                (e.__slideVideoInfo = os(e.src, !!e.video, s)),
                  e.__slideVideoInfo &&
            ...
            (e.prototype.loadContent = function (e, t) {
              ...
              if (
                ...
                if (g) {
                  ...
                  S = is(r, E || "", f, this.settings.strings.playVideo, p);
                  n.prepend(S);
                } else if (p) {
              ...
              var T = 0;
              v && !Yt(document.body).hasClass("lg-from-hash") && (T = v),
                this.isFirstSlideWithZoomAnimation() &&
                  (setTimeout(function () {
                    n.removeClass(
            ...
            (e.prototype.enableDrag = function () {
              ...
              this.settings.enableDrag &&
                ...
                Yt(window).on("mousemove.lg.global" + this.lgId, function (r) {
                  i &&
                    e.lgOpened &&
                    ((n = !0),
                ...
                Yt(window).on("mouseup.lg.global" + this.lgId, function (r) {
                  if (e.lgOpened) {
                    var o = Yt(r.target);
                    n
                      ? ((n = !1), e.touchEnd(s, t, r), e.LGel.trigger(Wt))
                      : e.isPosterElement(o) && e.LGel.trigger(Nt),
                      i &&
                        ((i = !1),
            ...
            (e.prototype.keyPress = function () {
              var e = this;
              Yt(window).on("keydown.lg.global" + this.lgId, function (t) {
                e.lgOpened &&
                  !0 === e.settings.escKey &&
                  27 === t.keyCode &&
                  (t.preventDefault(),
            ...
            (e.prototype.closeGallery = function (e) {
              ...
              this.LGel.trigger(Ht), Yt(window).scrollTop(this.prevScrollTop);
              var s,
              ...
              return (
                ...
                setTimeout(function () {
                  t.zoomFromOrigin &&
                    ...
                    t.$inner.empty(),
                    t.lgOpened && t.LGel.trigger(Vt, { instance: t }),
              ...
              return (
                setTimeout(function () {
                  e.destroyModules(!0),
                    ...
                    Yt(window).off(".lg.global" + e.lgId),
                    e.LGel.off(".lg"),
                    e.$container.remove();
                }, t),
                t
      ...
      const cs = function (e, t) {
        ...
        ds = document.querySelectorAll("[data-gallery]");
      ds.length &&
        ds.forEach((e) => {
          cs(e, {
